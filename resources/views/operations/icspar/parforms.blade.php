  ...
  <div class="br-section-wrapper">
     <div class="row">
          <div class="col-md-9 d-sm-flex">
            <div class="">
              <h4 class="tx-gray-800 mg-b-5">List of Property Acknowledgement Receipts</h4>
            </div>
          </div>
        </div>
                           ...
                           <div class="dropdown">
                             ...
                             <div class="dropdown-menu pd-10 wd-180 tx-14">
                                <nav class="nav nav-style-2 flex-column">                                  
                                  <a class="nav-link add" data-type="rfq"  title="Edit" data-date="{{$par['date']}}" data-id="{{$par['id']}}"><i class="fa fa-edit fa-xs"></i>Edit Form</a>
                                  <a class="nav-link printics" data-id="{{$par['id']}}"><i class="fa fa-print fa-xs"></i> Print Form</a>                             
                                </nav>
                              </div><!-- dropdown-menu -->
                            </div>
                        </div>
