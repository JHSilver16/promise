...
<div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <a class="breadcrumb-item" href="{{route('dashboard')}}">Home</a>
           <a class="breadcrumb-item" href="{{route('prs')}}">Purchase Requests</a>
          <span class="breadcrumb-item active">Add PR</span>
        </nav>
      </div><!-- br-pageheader -->
                      ...
                      <div class="row no-gutters">
                        ...
                        <div class="col-md-3 mg-t--1 mg-md-t-0">
                         ...
                         <div class="col-md-3 mg-t--1 mg-md-t-0">
                          <div class="form-group mg-md-l--1">
                           ...
                           <input type="text" class="form-control" name="date" required="" value="{{Carbon\Carbon::now()->toDateString()}}" readonly=""placeholder="MM/DD/YYYY">
                          </div>
                        </div>
                        <div class="col-md-10 mg-t--1 mg-md-t-0">
                          <div class="form-group mg-md-l--1">
                            <label class="form-control-label vlabel">Purpose: <span class="tx-danger">*</span></label>
                           <input type="text" name="purpose" class="form-control" value="" required=""  id="prno" placeholder="Purpose of purchase request">
                          </div>
                        </div>
                        <div class="col-md-2 mg-t--1 mg-md-t-0">
                          <div class="form-group mg-md-l--1">
                           ...
                           <label class="rdiobox">
                               <input name="rdio" type="radio" value="true">
                              <span>Within {{Carbon\Carbon::now()->year.' PPMP'}}</span>
                            </label>
                            <label class="rdiobox">
                              <input name="rdio" type="radio" value="false">
        ...
        <div class="table-wrapper pd-t-20">
            ...
            <table id="lines" class="table display responsive table-bordered nowrap tx-inverse tx-semibold tx-uppercase" style="width: 100%">
              ...
              <tbody class="tbody">
                <tr>
                  <td>
                    <input type="text" class="form-control stock" readonly="" name="items[1][stock]">
                  </td>
                  <td>
                  ...
                  <td>
                    <input type="number" step=".01" class="form-control total" onkeydown="isKeyPressed(event)"  name="items[1][total]">
                  </td>
              ...
              <tfoot>
                <tr>
                  <td colspan="4"></td>
                  <td>Total</td>
                  <td><input type="text" class="form-control" readonly="" name="total" id="total"></input><br/>
...
$(document).on('keyup', '.cost', function(){
  var cost = $(this).closest("td").prev().find('.qty').val();
  var qty = $(this).val();
  var total = cost * qty;
  console.log(total)
  $(this).closest("td").next().find('.total').val(total.toFixed(2))
  gettotald();
