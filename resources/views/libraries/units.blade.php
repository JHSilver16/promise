...
<div class="br-pageheader pd-y-15 pd-l-20">
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-18 mg-b-10">Unit of Measurement</h6>
       
    <form action="{{route('addunit')}}" method="POST" data-parsley-validate="">
       <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
        ...
        <div class="form-layout form-layout-2">
            <div class="row no-gutters">
             ...
             <div class="col-md-5 mg-t--1 mg-md-t-0">
                <div class="form-group mg-md-l--1">
                  <label class="form-control-label">Abbrevation: <span class="tx-danger">*</span></label>
                 <input type="text" name="agv" class="form-control" id="agv" placeholder="Abbrevation" required="">
                </div>
              </div>
            ...
            <table id="datatable1" class="table display table-hoverable responsive nowrap">
              <thead class="thead-colored thead-dark">
                <tr>
                  ...
                  <th class="wd-15p">Abbrevation</th>
                </tr>
              </thead>
