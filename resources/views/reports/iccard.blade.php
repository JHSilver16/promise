...
<div class="br-mainpanel"> 
 <div class="br-pagebody tx-roboto tx-inverse">
    <div class="br-section-wrapper">
      ...
      <h6 class="tx-bold tx-center">SEMI-EXPANDABLE EQUIPMENT CARD</h6>
    </div>
       </div>
       ...
       <div class="row bd bd-gray-900 bd-2">
        <div class="wd-100p">
         <table class="table-bordered tx-12 wd-100p">
          <tbody class="bd bd-2">
            <tr>
              <td class="wd-150p" rowspan="2"><b>Type of Semi-Expandable Equipment:</b> </td>
              <td></td>
            </tr>
            <tr>
              <td><b>Property No:</b> {{$ics->item_no}}</td>
            </tr>
            <tr>
              <td><b>Description: </b> {{$ics->brand.' '.$ics->name.' '.$ics->serial.' '.$ics->model.' '.$ics->color.' '.$ics->size}}</td>
              <td><b>Status: </b>{{$ics->item_status}}</td>
            </tr>
          </tbody>
        </table>
      </div>
