    ...
    <div class="br-section-wrapper">
      <div class="row">
        <div class="col-md-12 tx-center tx-black ">
          <h5 class="tx-bold tx-uppercase">EMPLOYEE'S PROPERTY ACCOUNTABILITY</h5>
            <p class="tx-12 lh-xs-1">As of {{$date}}</p>
        </div>
        </div>
    <div class="row tx-black ">
      <div class="col-md-12 tx-bold">Name: <u>{{$emp->first_name.' '.$emp->middle_name[0].'. '.$emp->last_name}}</u></div>
      <div class="col-md-12 tx-bold">Position: <u>{{$emp->position}}</u></div>
    </div>
