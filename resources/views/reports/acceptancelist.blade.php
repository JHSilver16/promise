 ...
 <div class="br-pagebody tx-roboto">
    <div class="br-section-wrapper">
      <div class="row">
        ...
        <h4 class="tx-bold">List of Inspected POs</h4>
        <hr/>
        ...
        <table class="table table-bordered" id="table2excel">
          ...
          <thead>
            <tr>
              ...
              <th class="wd-15p">Procurement Mode</th>
              <th class="wd-15p">Amount</th>
              <th class="wd-15p">IAR No</th>
              <th class="wd-15p">Date Received</th>
              <th class="wd-15p">Received By</th>
              <th class="wd-15p">Date Inspected</th>
          ...
          <tbody>
              @foreach($acc as $ac)
                  <tr>  
                      ...
                      <td>{{$ac['amount']}}</td>
                      <td>{{$ac['accref']}}</td>
                      <td>{{$ac['date_received']}}</td>
                      <td>{{$ac['rcfull_name']}}</td>
                      <td>{{$ac['date_inspected']}}</td>
                      <td>{{$ac['infull_name']}}</td>
                  </tr>
              @endforeach
          </tbody>
        </table>
  ...
  $(function(){
    ...
    if(document.getElementById('type').value == 'csv'){
        $("#table2excel").table2excel({
          ...
          exclude: ".noExl",
          name: "Worksheet Name",
          filename: "List of Inspected POs", //do not include extension
