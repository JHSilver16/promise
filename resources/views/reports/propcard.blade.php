...
<div class="br-mainpanel"> 
 <div class="br-pagebody tx-roboto tx-inverse">
    <div class="br-section-wrapper">
      ...
      <h6 class="tx-bold tx-center">PROPERTY CARD</h6>
    </div>
       </div>
       <div class="row pd-t-5">
         <div class="col-sm pd-r-5">Entity Name: {{$prop->entity}}</div>          
         
         <div class="col-sm-5"></div>
         <div class="col-sm">Fund Cluster: {{$prop->fund}}</div> 
       </div>
       <div class="row bd bd-gray-900 bd-2">
        <div class="wd-100p">
         <table class="table-bordered tx-12 wd-100p">
          <tbody class="bd bd-2">
            <tr>
              <td class="wd-150p" rowspan="2"><b>Type of Property, Plant and Equipment:</b> {{$prop->ppe}}</td>
              <td><b>Estimated Useful Life:</b> {{$prop->life}}</td>
            </tr>
            <tr>
              <td><b>Property No:</b> {{$prop->property_no}}</td>
            </tr>
            <tr>
              <td><b>Description: </b>{{$prop->brand.' '.$prop->name.' '.$prop->serial.' '.$prop->model.' '.$prop->color.' '.$prop->size}}</td>
              <td><b>Status: </b>{{$prop->item_status}}</td>
            </tr>
          </tbody>
        </table>
      </div>
         ...
         <table class="table-bordered tx-12 wd-100p">
          <thead class="bd bd-2">
            <tr>
              ...
              <th rowspan="2">Rate of Depreciation</th>
            </tr>
            <tr>
              <th>Qty</th>
              <th>Qty</th>
