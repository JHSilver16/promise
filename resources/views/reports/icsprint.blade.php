...
<div class="br-mainpanel"> 
 <div class="br-pagebody tx-roboto tx-inverse">
    <div class="br-section-wrapper">
      ...
      <h6 class="tx-bold tx-center">Inventory Custodian Slip</h6>
    </div>
       </div>
       <div class="row pd-t-5">
         <div class="col-sm-12 pd-r-5">Entity Name: {{$ics->entity}}</div>          
         <div class="col-sm-3">Fund Cluster: {{$ics->fund_cluster}}</div>
         <div class="col-sm-6"></div>
         <div class="col-sm-3">ICS No:{{$ics->ref_no}} </div> 
       </div>
        ...
        <div class="wd-100p">
         <table class="table-bordered tx-12 wd-100p">
          ...
          <div class="row tx-12 pd-t-5 pd-b-5 ">
            ...
            <div class="col-sm-3 pd-b-10 "></div>
            <div class="col-sm-3 tx-center bd-b">{{$ics->date}}  </div>
            <div class="col-sm-3 pd-b-10 "></div>
            <div class="col-sm-3 tx-center bd-b">{{$ics->date}} </div>
