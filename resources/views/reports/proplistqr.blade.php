      ...
      <div class="row">
       ...
       <div class="row">
        @foreach($properties as $prop)
            <div class="col-sm-6">
              <table class="table bd bd-gray-900 tx-black tx-10">
                <tbody>
                  <tr class="bd bd-gray-900">
                    <td rowspan="4" id="qr" class="qr" data-id="{{$prop->property_no}}" >
                      
                    </td>
                  </tr>
                  <tr class="pd-l-10">
                    <td class="wd-20p"><img src="{{asset('images/republiclogo.png')}}" class="poweredbyLogo float-center">
                    <img src="{{asset('images/nedalogo.png')}}" class="poweredbyLogo  float-center"></td>
                    <td>
                      <div>Republic of the Philippines</div>
                      <div>National Economic and Development Authority</div>
                      <div>Regional Office XII - SOCCSKARGEN Region</div>
                    </td>
                  </tr>
                  <tr>
                    <td>Property No.</td>
                  ...
                  <tr>
                    <td>{{$prop->property_no}}</td>
                    <td>{{$prop->name}}</td>
                    <td>{{$prop->brand.' '.$prop->model}}</td>
                    <td>{{$prop->serial}}</td>
