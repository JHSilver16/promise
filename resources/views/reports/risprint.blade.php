...
<div class="br-mainpanel"> 
 <div class="br-pagebody tx-roboto tx-inverse">
    <div class="br-section-wrapper">
      ...
      <h6 class="tx-bold tx-center">REQUISITION AND ISSUE SLIP</h6>
    </div>
       </div>
       <div class="row pd-t-5">
         <div class="col-sm pd-r-5">Entity Name: {{$ris->entity}}</div>          
         
         <div class="col-sm-5"></div>
         <div class="col-sm">Fund Cluster:{{$ris->fund_cluster}} </div> 
       </div>
       <div class="row pd-t-5 bd pd-x-5 pd-y-10 bd-gray-900 bd-2">
         <div class="col-sm-1">Division: </div>
         <div class="col-sm-4 bd-b bd-2"> </div>   
         <div class="col-sm-3 pd-r-5">Responsibility Center Code: </div>
         <div class="col-sm-4 bd-b bd-2"> </div>         
         <div class="col-sm-1 ">Office: </div>
         <div class="col-sm-4 bd-b bd-2"> NEDA XII</div>   
         <div class="col-sm-2 pd-r-5">RIS No: </div>
         <div class="col-sm-5 bd-b bd-2">{{$ris->ref_no}} </div> 
       ...
       <div class="row bd bd-gray-900 bd-2">
        <div class="wd-100p">
         <table class="table-bordered tx-12 wd-100p">
          ...
          <tbody class="bd">
            @foreach($ris_line as $pr)
            <tr>
           
               <td class="wd-10p">{{$pr->stock}}</td>
               <td class="wd-10p">{{$pr->unit}}</td>
               <td class="wd-10p">{{$pr->name}}</td>
               <td class="wd-10p">{{$pr->req_qty}}</td>
               <td class="wd-10p">{{$pr->issued_qty > 0 ? 'X' : ''}}</td>
               <td class="wd-10p">{{($pr->issued_qty != null && $pr->issued_qty == 0) ? 'X' : ''}}</td>
               <td class="wd-10p">{{$pr->issued_qty}}</td>
               <td class="wd-10p">{{$pr->remarks}}</td>
            </tr>
            @endforeach
          </tbody>
          <tfoot>
          ...
          <div class="row tx-12 pd-t-5 pd-b-5 bd bd-gray-900 bd-2">
            <div class="col-sm-2 bd-r bd-gray-900 bd-2">
              <div class="row">
                <div class="col-sm-12 bd-b  pd-t-20">Signature: </div>
                <div class="col-sm-12 bd-b">Printed Name: </div>
                <div class="col-sm-12 bd-b">Designation: </div>
                <div class="col-sm-12 bd-b">Date: </div>
              </div>
            </div>
            <div class="col-sm-3 tx-12">
              <div class="row">
                <div class="col-sm-12 bd-b pd-b-20">Requested by: </div>
                <div class="col-sm-12 bd-b">{{$ris->rqfullname}}</div>
                <div class="col-sm-12 bd-b">{{$ris->rqpos}}</div>
                <div class="col-sm-12 bd-b">{{$ris->date_requested}}</div>
              </div>
            </div>

            <div class="col-sm-3 tx-12">
              <div class="row">
                <div class="col-sm-12 bd-b pd-b-20">Approved by: </div>
                <div class="col-sm-12 bd-b">{{$ris->apfullname}}</div>
                <div class="col-sm-12 bd-b">{{$ris->appos}}</div>
                <div class="col-sm-12 bd-b">{{$ris->date_approved}}</div>
              </div>
            </div>

            <div class="col-sm-2 tx-12">
              <div class="row">
                <div class="col-sm-12 bd-b pd-b-20">Issued by: </div>
                <div class="col-sm-12 bd-b">{{$ris->infull_name}}</div>
                <div class="col-sm-12 bd-b">{{$ris->inpos}}</div>
                <div class="col-sm-12 bd-b">{{$ris->date_issued}}</div>
              </div>
            </div>

            <div class="col-sm-2 tx-12">
              <div class="row">
                <div class="col-sm-12 bd-b pd-b-20">Received by: </div>
                <div class="col-sm-12 bd-b">{{$ris->rcfull_name}}</div>
                <div class="col-sm-12 bd-b">{{$ris->rcpos}}</div>
                <div class="col-sm-12 bd-b">{{$ris->date_received}}</div>
              </div>
            </div>
