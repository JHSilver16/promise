...
<div class="br-mainpanel"> 
 <div class="br-pagebody tx-roboto tx-inverse">
    <div class="br-section-wrapper">
      ...
      <h6 class="tx-bold tx-center">PROPERTY ACKNOWLEDGEMENT RECEIPT</h6>
    </div>
       </div>
       <div class="row pd-t-5">
         <div class="col-sm-12 pd-r-5">Entity Name: {{$par->entity}}</div>          
         <div class="col-sm-3">Fund Cluster: {{$par->fund}}</div>
         <div class="col-sm-6"></div>
         <div class="col-sm-3">PAR No:{{$par->ref_no}} </div> 
       </div>
       ...
       <div class="row bd bd-gray-900 bd-2">
        <div class="wd-100p">
         <table class="table-bordered tx-12 wd-100p">
          ...
          <div class="row tx-12 pd-t-5 pd-b-5 ">

            <div class="col-sm-3 pd-b-10">Received by: </div>
            <div class="col-sm-3 pd-b-10"></div>
            <div class="col-sm-3 pd-b-10">Issued by: </div>
            <div class="col-sm-3 pd-b-10"></div>
            <div class="col-sm-3 pd-b-10"></div>
            <div class="col-sm-3 tx-center bd-b">{{$issued_to->first_name.' '.$issued_to->middle_name[0].' '.$issued_to->last_name}} </div>
            <div class="col-sm-3 pd-b-10"></div>
            <div class="col-sm-3 tx-center bd-b">{{$issued_by->first_name.' '.$issued_by->middle_name[0].' '.$issued_by->last_name}}  </div>
            <div class="col-sm-3 pd-b-20"></div>
            <div class="col-sm-3 tx-center ">Signature Over Printed Name of Accountable Officer </div>
            <div class="col-sm-3 pd-b-10"></div>
            <div class="col-sm-3 tx-center ">Signature Over Printed Name of Supply/Property Custodian </div>
            <div class="col-sm-3 pd-b-20"></div>
            <div class="col-sm-3 tx-center ">{{$issued_to->position}} </div>
            <div class="col-sm-3 pd-b-10"></div>
            <div class="col-sm-3 tx-center ">{{$issued_by->position}}  </div>

            <div class="col-sm-3 pd-b-10 "></div>
            <div class="col-sm-3 tx-center bd-b">{{$par->date}}  </div>
            <div class="col-sm-3 pd-b-10 "></div>
            <div class="col-sm-3 tx-center bd-b">{{$par->date}} </div>

            <div class="col-sm-3 pd-b-10"></div>
            <div class="col-sm-3 tx-center">Date</div>
            <div class="col-sm-3 pd-b-10"></div>
            <div class="col-sm-3 tx-center">Date </div>
